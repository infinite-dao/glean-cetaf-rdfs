...
echo -e  "############  SNSB, Munich: Parse and normalize RDF to TriG (\e[31mdebug mode\e[0m) ####"
else
...
# plus trig format
  ...
  echo -e  "# \e[32m(4)   add/check ROR ID (... id.snsb.info…/collection/ or …/collection_monitoring/ aso.)\e[0m" ;
  sed --regexp-extended --in-place '
