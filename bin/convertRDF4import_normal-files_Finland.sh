...
echo -e  "############  Finland: Parse and normalize RDF to TriG (${RED}debug mode${NOFORMAT}) ####"
else
...
# plus trig format
  ...
  echo -e  "# ${GREEN}(4)   check RORID, delete technical stuff, add isPartOf aso. (... id.herb.oulu.fi, tun.fi aso.)${NOFORMAT}" ;
  sed --regexp-extended --in-place '
...
echo  -e "# ${GREEN}Added: ${BLUE_BOLD}dcterms:isPartOf <http://gbif.fi>${GREEN}${NOFORMAT}"
