...
echo -e  "############  Meise (www.botanicalcollections.be): Parse and normalize RDF to TriG (${RED}debug mode${NOFORMAT}) ####"
else
echo -e  "############  Meise (www.botanicalcollections.be): Parse and normalize RDF to TriG #################"
fi
...
# plus trig format
  ...
  echo -e  "# ${GREEN}(4)   add/check ROR ID (... www.botanicalcollections.be aso.)${NOFORMAT}" ;
  sed --regexp-extended --in-place '
